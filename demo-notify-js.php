        ...
        if ($response->getReceiverId() == RECEIVER_ID) {
            ...
            if ($response->getStatus() == 'done'
             //&& $response->getAmount() == $amount
                ...
                VALUES (
                    '".$run."','".$payment_idDB."',CURRENT_TIMESTAMP,2,'".$notification_tokenDB."','".$receiver_idDB."','".$bankDB."','".$payer_nameDB."','".$payer_emailDB."','".$responsible_user_mailDB."','".$payment_methodDB."','".$valorTransaccionDB."'
                );";
